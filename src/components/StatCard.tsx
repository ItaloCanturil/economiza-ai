...
export function StatCard({ title, value, change, bgColor, icon }: StatCardProps) {
  ...
  return (
    ...
    transition={{ duration: 1 }}
      className="text-3xl font-semibold">{formattedValue}</motion.p>
      <p className={`mt-2 text-sm ${change.isPositive ? 'text-green-200' : 'text-red-200'}`}>
